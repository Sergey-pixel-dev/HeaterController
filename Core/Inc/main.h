...
// ============================================================================
#define CALIB_INITIAL_I 3000 // Начальный ток для калибровки
#define COEF_A_DEFAULT 30    // c_a по умолчанию (без сдвига)
#define COEF_B_DEFAULT 30    // c_b по умолчанию (без сдвига)
